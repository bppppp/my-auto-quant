...
- name: rebalance_freq_days
  ...
  reason: 维持5日周频，当前无调仓频率引发的问题，保持稳定。
- name: max_holding_days
  ...
  reason: 时间止损盈利全胜，延长至45日让强趋势股充分上涨。
...
- name: volume_threshold
  ...
  reason: 当前2.0远高于量能P75(1.29)过严致入场少；下调至1.6扩大机会同时保质量。
...
- name: adx_threshold
  ...
  reason: ADX中位23,阈值30略严限制入场；降至28保持过滤同时增加交易机会。
- name: trailing_stop_pct
  ...
  reason: trailing触达34次胜率仅41%，放宽至0.12减少过早止盈，让趋势充分发展。
- name: fixed_stop_pct
  default: 0.15
  range:
  - 0.03
  ...
  reason: 固定止损仅触发1次，现0.15有效防止过早止损，维持不变。
- name: entry_score_threshold
  ...
  reason: 维持1.0确保三信号确认，当前胜率47.5%接近目标，不下调。
