"""创业板 50 + 科创板 50 股票池. 见 subject.md §3 / data/config.py.
...
# 带交易所后缀的 CYB_STAR_50 codes
_RAW_CYB_STAR_50: list[str] = _data_config.CYB_STAR_50

CYB_STAR_50_CODES: list[str] = [_add_suffix(c) for c in _RAW_CYB_STAR_50]
"""创业板 50 + 科创板 50 成分股, 带交易所后缀, 与 data_loader preprocess 后的 ``df['代码']`` 对齐."""
