...
- name: partial_profit_pct
  ...
  reason: v17 overbought_reduce 100%胜+5800稳定,保持0.15
...
- name: atr_stop_multiplier
  ...
  reason: v17 vol_stop 6632触发2.61%胜盈亏比极差,放宽至3.8减少whipsaw
- name: trail_stop_pct
  default: 0.14
  range:
  - 0.05
  ...
  reason: v17 trail_stop 6262触发9.77%胜,放宽至0.14向v15靠拢减少假突破
...
- name: rsi_overbought
  ...
  reason: overbought_reduce 100%胜+5800稳定,保持75
- name: fixed_stop_loss_pct
  ...
  reason: v17 0.12触发翻倍但avg仅微降,微调至0.11强化灾损保护
...
- name: max_holding_days
  ...
  reason: time_stop 69%胜+948为正贡献,延长至35让趋势充分发展
