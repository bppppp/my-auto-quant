...
- name: partial_profit_pct
  ...
  reason: v4 0.15时overbought均收5895最佳,v7 0.13为5170,提至0.15提升单笔质量
...
- name: atr_stop_multiplier
  ...
  reason: v6 2.0致vol_stop 26242次噪音,v7 2.5降至16004合理,保持
- name: trail_stop_pct
  default: 0.08
  range:
  - 0.05
  ...
  reason: v7 0.12仅触发2628次偏少,降至0.08接近v5的3515次,提升触发密度
...
- name: rsi_overbought
  ...
  reason: v4 75时overbought均收5895最佳,v7 74为5170,提至75提升质量
- name: fixed_stop_loss_pct
  ...
  reason: v4 0.08频次合理(v5 0.13过深-4331),降至0.10保留趋势空间
...
- name: max_holding_days
  ...
  reason: v6 30天time_stop胜率86.9%+1443均收,5份报告稳定,保持
