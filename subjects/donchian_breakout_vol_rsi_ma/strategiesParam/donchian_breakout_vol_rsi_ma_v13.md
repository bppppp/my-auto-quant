...
- name: rsi_entry_low
  ...
  reason: v12 RSI入场胜率不高，提高至60改善质量，参考v8低触发高收益
...
- name: rsi_overbought
  ...
  reason: v8减仓盈利极高，提至70让利润奔跑，降低过早止盈
- name: max_holding_days
  ...
  reason: time_stop胜率高均盈正，60日让趋势充分发展，维持
- name: trail_stop_pct
  default: 0.12
  range:
  - 0.08
  ...
  reason: v12触发频繁均亏大，收紧至0.12保护浮盈，参考v8低总亏
- name: atr_stop_multiplier
  ...
  reason: v12触发过多，提至3.5减少噪音出场，v8总亏低时略高
- name: rsi_entry_high
  default: 70
  range:
  - 50
  ...
  reason: 配合rsi_entry_low=60，维持70适中防超买，保持合理区间
- name: fixed_stop_loss_pct
  ...
  reason: v12单笔亏损大，收紧至0.12控单笔损失，参考v8适度触发
...
- name: vol_breakout_threshold
  ...
  reason: v8阈值2.3质量高，v12维持，效果稳定，维持
...
- name: partial_profit_pct
  ...
  reason: v8高止盈盈利大，提至0.15提高单笔利润，避免微利减仓
