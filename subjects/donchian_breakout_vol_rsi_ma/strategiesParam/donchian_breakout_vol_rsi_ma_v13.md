...
- name: partial_profit_pct
  ...
  reason: overbought_reduce v8-v12均胜率100%均收+5800~+5916,稳定,保持0.15
...
- name: rsi_entry_high
  ...
  reason: 入场0触发为结构问题(close>donchian_high_20),参数非主因,保持80
- name: atr_stop_multiplier
  ...
  reason: 5份中3.0触发最少(5318),v12轨迹更紧,与trail回调后联调,保持3.0
- name: trail_stop_pct
  default: 0.1
  range:
  - 0.05
  ...
  reason: v12收紧至0.08触发17485次(v11 1474的12倍),胜率反降3pp,回调至0.10
...
- name: rsi_overbought
  ...
  reason: v8-v12 overbought_reduce均100%胜率+5800,保持75
- name: fixed_stop_loss_pct
  ...
  reason: v12触发945次,v11为3034,trail回调至0.10后预期回升,保持0.12
...
- name: max_holding_days
  ...
  reason: 5份time_stop胜率72-82%均收正,30日贴合波段,保持
