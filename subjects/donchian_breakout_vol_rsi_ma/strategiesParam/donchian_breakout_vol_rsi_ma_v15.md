...
- name: partial_profit_pct
  ...
  reason: v14 overbought_reduce 4412次100%胜率+5852,稳定,保持0.15
- name: rebalance_freq_days
  ...
  reason: 组合层参数,v14无频率问题,5日与波段匹配,保持
- name: rsi_entry_high
  default: 80
  range:
  - 50
  ...
  reason: 入场0触发为结构bug,信号未运行,参数非主因,保持80
- name: atr_stop_multiplier
  ...
  reason: v14 3.3触发6875次2.62%胜率-1713,继续放宽至3.5降噪
- name: trail_stop_pct
  default: 0.12
  range:
  - 0.05
  ...
  reason: v14 0.11触发6488降至v13 72%,年化微升,继续放宽至0.12
- name: vol_breakout_threshold
  ...
  reason: 0.7处p25偏严,系统提示下调,降至0.5放宽窗口
...
- name: target_holdings
  ...
  reason: 8只×10%=80%资金利用率,v14稳定,保持
- name: rsi_overbought
  default: 75
  range:
  - 65
  ...
  reason: v14 100%胜率+5852,稳定,保持75
- name: fixed_stop_loss_pct
  ...
  reason: v14 2257次0%胜-3997,收紧至0.10限单笔损失
...
- name: rsi_entry_low
  ...
  reason: 入场0触发为结构bug,20放宽窗口保留动量,保持
...
- name: max_holding_days
  ...
  reason: v14 time_stop 18483次69.57%胜+962,30日贴合,保持
...
- name: max_single_weight
  ...
  reason: 与target_holdings=8匹配,集中度非核心,保持0.1
