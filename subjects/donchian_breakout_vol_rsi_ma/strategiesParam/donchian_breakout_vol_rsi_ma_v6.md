...
- name: partial_profit_pct
  ...
  reason: v5 0.10致overbought均收从5895降至4278,提至0.12保单笔利润质量
...
- name: atr_stop_multiplier
  ...
  reason: v5 2.5致vol_stop 16789次5.8%胜率过频,恢复2.0降噪止损
- name: trail_stop_pct
  default: 0.13
  range:
  - 0.05
  ...
  reason: v5 0.12触发3515次7%胜率,再放宽0.13让利润充分跑出
- name: vol_breakout_threshold
  ...
  reason: v5 0.4远低于p25=0.70,恢复1.0接近p55为A股合理值
...
- name: rsi_overbought
  ...
  reason: v5 72致overbought均收从5895降至4278,提至73平衡量与质
- name: fixed_stop_loss_pct
  ...
  reason: v5 0.13触发1445次均亏-4331过深,收窄至0.12减少大亏
- name: add_position_weight_threshold
  ...
  reason: 入场=0参数未生效,0.3已很低,保持待入场逻辑修复
...
- name: rsi_entry_low
  ...
  reason: v5 20远低于p25=37.9,恢复30为A股合理值,避免接飞刀
...
- name: max_holding_days
  ...
  reason: v5 30天time_stop 75.9%胜率+947均收良好,保持
