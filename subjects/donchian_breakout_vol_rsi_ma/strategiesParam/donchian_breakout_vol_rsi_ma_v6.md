...
- name: rsi_entry_low
  ...
  reason: 调高RSI入场下限至48，进一步过滤弱势反弹，提升胜率
...
- name: trail_stop_pct
  ...
  reason: 放宽移动止损至13%，减少回撤噪音误触，提升趋势持仓
...
- name: atr_stop_multiplier
  ...
  reason: 上调ATR倍数至3.6，降低噪音出场，减少无效止损
- name: fixed_stop_loss_pct
  ...
  reason: 维持10%固定止损，平衡单笔亏损与正常波动容忍
...
- name: rsi_entry_high
  ...
  reason: 下调入场上限至62，避免追高，提升入场安全边际
- name: reduce_position_weight_threshold
  ...
  reason: 微调减仓阈值至0.45，延缓减仓，保留趋势仓位
