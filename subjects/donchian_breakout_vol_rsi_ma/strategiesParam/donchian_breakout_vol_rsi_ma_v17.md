...
- name: partial_profit_pct
  ...
  reason: v16 overbought_reduce 100%胜+5837,保持0.15
...
- name: atr_stop_multiplier
  ...
  reason: v16 3.0致vol_stop 7795,放宽至3.3向v15靠拢
- name: trail_stop_pct
  default: 0.11
  range:
  - 0.05
  ...
  reason: v16 0.10致trail_stop 9381,放宽至0.11向v15靠拢
...
- name: fixed_stop_loss_pct
  ...
  reason: v16 0.13致avg-4391,收紧至0.12降单笔深亏
...
- name: max_holding_days
  ...
  reason: time_stop 74%胜+1095,稳定,保持30
