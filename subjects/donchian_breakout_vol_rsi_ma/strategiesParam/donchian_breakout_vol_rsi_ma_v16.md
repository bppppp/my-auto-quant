...
- name: partial_profit_pct
  ...
  reason: v15 overbought_reduce 100%胜+5857,稳定,保持0.15
...
- name: atr_stop_multiplier
  ...
  reason: v15 3.5致vol_stop降至5681,收紧至3.0恢复中间止损
- name: trail_stop_pct
  default: 0.1
  range:
  - 0.05
  ...
  reason: v15 0.12过宽致fixed_stop飙5636,收紧至0.10
- name: vol_breakout_threshold
  ...
  reason: v15 0.5远低于p25=0.7,上调至0.8靠近分位
...
- name: target_holdings
  ...
  reason: 8只×10%=80%资金利用率,v15稳定,保持
- name: rsi_overbought
  default: 75
  range:
  - 65
...
- name: fixed_stop_loss_pct
  ...
  reason: v15 0.10触发5636次,放宽至0.13让trail/vol先接
...
- name: max_holding_days
  ...
  reason: time_stop 19326次68%胜+899,稳定,保持30
