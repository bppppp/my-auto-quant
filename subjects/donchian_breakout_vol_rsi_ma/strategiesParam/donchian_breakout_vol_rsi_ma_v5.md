...
- name: partial_profit_pct
  ...
  reason: overbought_reduce 100%胜率+5895均收是最佳信号，降至0.10扩触发
...
- name: rsi_entry_high
  ...
  reason: 入场仍=0与RSI阈值无关，非核心瓶颈，保持70
- name: atr_stop_multiplier
  ...
  reason: v4 vol_stop 9445次均亏-1203明显改善，保持2.5
- name: trail_stop_pct
  default: 0.12
  range:
  - 0.05
  ...
  reason: v4 0.08过紧触发13798次84%亏损，放宽至0.12让利润跑
- name: vol_breakout_threshold
  ...
  reason: p25=0.70阈值已过松，入场0与量能无关，保持0.4
...
- name: target_holdings
  ...
  reason: 与max_single_weight=0.1匹配合理，保持
- name: rsi_overbought
  default: 72
  range:
  - 65
  ...
  reason: 100%胜率+5895均收核心利润源，降至72扩触发窗口
- name: fixed_stop_loss_pct
  ...
  reason: v4 0.10触发2478次均亏-3477，放宽至0.13降频减总亏
- name: add_position_weight_threshold
  ...
  reason: v4已降至0.3仍未解锁入场=0，疑似非参数问题，保持待诊断
...
- name: rsi_entry_low
  ...
  reason: p25=37.9阈值已远低于此，入场0与RSI下限无关，保持20
...
- name: max_holding_days
  ...
  reason: v4 25天胜率77%均收+1200良好，延至30让趋势利润充分释放
...
- name: max_single_weight
  ...
  reason: 与target_holdings=8匹配合理，年化低不源于集中度，保持
