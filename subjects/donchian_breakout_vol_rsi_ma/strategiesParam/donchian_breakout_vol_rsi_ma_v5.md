...
- name: rsi_entry_low
  ...
  reason: 上调RSI入场下限至45，过滤弱势反弹，提升胜率
- name: reduce_position_weight_threshold
  ...
  reason: 提高减仓阈值至0.42，延缓减仓，保留强势趋势仓位
- name: rsi_overbought
  default: 73
  range:
  - 60
  ...
  reason: 上调超买阈值至73，让盈利股继续发展，提升盈亏比
- name: max_holding_days
  ...
  reason: 延长最大持仓至42日，让趋势股充分运行，改善盈亏比
- name: trail_stop_pct
  default: 0.12
  range:
  - 0.03
  ...
  reason: 放宽移动止损至12%，减少回撤噪音误触，提升趋势持仓
- name: atr_stop_multiplier
  ...
  reason: 上调ATR倍数至3.3，降低噪音出场，减少无效止损
- name: rsi_entry_high
  default: 65
  range:
  - 50
  ...
  reason: 下调入场上限至65，减少追高，提升入场安全边际
- name: fixed_stop_loss_pct
  ...
  reason: 收紧固定止损至10%，控制单笔最大亏损，防极端风险
...
- name: add_position_weight_threshold
  ...
  reason: 提高加仓阈值至0.7，要求更强信号共振，提升胜率
- name: vol_breakout_threshold
  ...
  reason: 上调成交量阈值至1.8，过滤弱势突破，提升入场质量
