...
- name: rsi_entry_low
  ...
  reason: 下调至50放宽入场，v9过滤过严致收益降，RSI中位50附近合理
...
- name: rsi_overbought
  ...
  reason: 下调至60增加止盈触发，overbought_reduce胜率100%且均盈高
- name: max_holding_days
  ...
  reason: time_stop胜率79%均盈1608，维持60让趋势充分发展
- name: trail_stop_pct
  default: 0.18
  range:
  - 0.05
  ...
  reason: 放宽至0.18减少过早出场，v9紧止损触发激增总亏损大
...
- name: atr_stop_multiplier
  ...
  reason: 提高至3.5减少volatility_stop频繁触发，参考v8宽松表现
- name: fixed_stop_loss_pct
  ...
  reason: 放宽至0.14减少止损频繁触发，v8总亏损更小
...
- name: vol_breakout_threshold
  ...
  reason: 下调至2.0增加入场信号，v9过严(2.5)致breakout_entry减少
...
- name: partial_profit_pct
  ...
  reason: 下调至0.10继续增加止盈，v9止盈总盈利大幅提升
