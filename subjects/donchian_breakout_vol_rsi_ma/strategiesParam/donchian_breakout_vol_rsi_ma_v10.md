...
- name: partial_profit_pct
  ...
  reason: v9 overbought_reduce均收+5804胜率100%,5份报告稳定,保持
- name: rebalance_freq_days
  ...
  reason: 5份报告均稳定,5日节奏与中周期波段匹配,保持
- name: rsi_entry_high
  default: 80
  range:
  - 50
  ...
  reason: 入场0触发,rsi p75=62,70上限过低,上调至80启用动量入场
- name: atr_stop_multiplier
  ...
  reason: v9 2.5触发15992次仅7%胜率,上调至3.0减少噪音止损
- name: trail_stop_pct
  default: 0.12
  range:
  - 0.05
  ...
  reason: v9 0.12触发2685次合理,v8 0.08=13761噪音多,保持0.12
- name: vol_breakout_threshold
  ...
  reason: 入场0触发,1.2处p75仅25%放量日,下调至0.7启用突破
...
- name: target_holdings
  ...
  reason: 8只×10%=80%资金利用率,与max_single匹配,保持
- name: rsi_overbought
  default: 75
  range:
  - 65
  ...
  reason: v9 overbought_reduce 100%胜率+5804,保持75
- name: fixed_stop_loss_pct
  ...
  reason: v9 0.12触发2127次中位11天,保留趋势合理,保持
- name: add_position_weight_threshold
  ...
  reason: 入场未生效,加仓未触发,保持0.3待入场逻辑修复验证
...
- name: rsi_entry_low
  ...
  reason: 入场0触发,30处p25以下仅20%日,下调至20允许超卖反弹
...
- name: max_holding_days
  ...
  reason: v9 time_stop 80%胜率+1350均收,5份报告稳定,保持30
...
- name: max_single_weight
  ...
  reason: 与target_holdings=8匹配,集中度非核心问题,保持
