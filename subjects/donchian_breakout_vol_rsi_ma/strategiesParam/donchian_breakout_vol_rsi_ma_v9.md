...
- name: rsi_entry_low
  ...
  reason: v8 rsi_entry中位亏损-177，提高低限至55过滤弱信号
...
- name: rsi_overbought
  ...
  reason: 下调至65增加止盈触发，v8止盈均盈6495优质
- name: max_holding_days
  ...
  reason: v8 time_stop胜率72.5%均盈1608，维持60让趋势充分发展
- name: trail_stop_pct
  default: 0.12
  range:
  - 0.03
  ...
  reason: v8均亏-2286，收紧至0.12减少回撤，提升盈亏比
- name: atr_stop_multiplier
  ...
  reason: v8放宽至4.5均亏恶化，回调至3.0降低单笔止损亏损
- name: rsi_entry_high
  default: 65
  range:
  - 50
  ...
  reason: 配合低限上调至55，范围55-65捕捉强趋势避免超买
- name: fixed_stop_loss_pct
  ...
  reason: v8放宽至0.15均亏变大，收紧至0.12控制最大亏损
...
- name: vol_breakout_threshold
  ...
  reason: v8突破胜率39%均利153，再提升至2.5强化量能过滤
...
- name: partial_profit_pct
  ...
  reason: 下调至0.12增加止盈频率，v8止盈优质，提升总体盈利
