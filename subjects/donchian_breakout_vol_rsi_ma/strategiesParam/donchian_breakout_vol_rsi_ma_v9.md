...
- name: partial_profit_pct
  ...
  reason: v8=0.15时overbought均收+5883,v7 0.13为+5170,保持
...
- name: atr_stop_multiplier
  ...
  reason: v8 2.5降至9688次(v6 2.0=26242),过滤效果可,保持
- name: trail_stop_pct
  default: 0.12
  range:
  - 0.05
  ...
  reason: v7 0.12仅2628次合理,v8 0.08暴增至13761噪音多,上调至0.12
- name: vol_breakout_threshold
  ...
  reason: 入场触发=0,描述默认1.5但实为1.0,上调至1.2修复
...
- name: rsi_overbought
  ...
  reason: v8=75时overbought均收+5883,与v4 75时+5895一致,保持
- name: fixed_stop_loss_pct
  ...
  reason: v8 0.10中位8天太短,v5 0.13=11天,上调至0.12保留趋势
...
- name: max_holding_days
  ...
  reason: v8 30天time_stop胜率82%+1381均收,5份报告稳定,保持
