...
- name: rsi_entry_high
  ...
  reason: v2降至65仍0入场，恢复70配合rsi_low下调扩大窗口
- name: atr_stop_multiplier
  ...
  reason: 触发17186次胜率11%偏低，待入场恢复后下一轮评估
- name: trail_stop_pct
  default: 0.1
  range:
  - 0.03
  ...
  reason: v2=0.08总亏损-14.2M优于v1=-16.0M，继续放宽至0.10
- name: vol_breakout_threshold
  ...
  reason: p25=0.70当前1.0仍过严，下调至0.5争取放量入场
...
- name: fixed_stop_loss_pct
  ...
  reason: 0.10总止损-7.2M优于0.08=-9.2M，继续放宽至0.13
- name: add_position_weight_threshold
  ...
  reason: v2入场仍0疑门槛过高，下调至0.4解锁趋势+rsi=0.5
...
- name: rsi_entry_low
  ...
  reason: p25=37.9当前30仍偏严，下调至25扩大入场窗口
...
- name: max_holding_days
  ...
  reason: 触发14919次胜率84.64%(均收+1450)，良好保持
