...
- name: partial_profit_pct
  ...
  reason: v10 overbought_reduce胜率100%均收+5806,5份报告稳定,保持0.15
...
- name: atr_stop_multiplier
  ...
  reason: v10触发10297次胜率3.95%,3.0已偏高,继续上调均收反恶化,保持
- name: trail_stop_pct
  default: 0.14
  range:
  - 0.05
  ...
  reason: P/L比1.44趋势下滑(v6→v10:1.74→1.44),trail触发偏多,松至0.14让赢家多跑
...
- name: rsi_overbought
  ...
  reason: overbought_reduce胜率100%均收+5806,5份报告稳定,保持75
- name: fixed_stop_loss_pct
  ...
  reason: v10触发2757次中位12天,12%止损贴合中周期波段,保持
...
- name: max_holding_days
  ...
  reason: time_stop胜率72.7%均收+1051,5份报告稳定,保持30
