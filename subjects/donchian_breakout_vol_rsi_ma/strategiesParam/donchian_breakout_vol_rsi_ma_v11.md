...
- name: rsi_entry_low
  ...
  reason: v10 rsi_entry_low=50致信号激增质量降，提高至55收紧过滤，参考v8表现
...
- name: rsi_overbought
  ...
  reason: v10 overbought_reduce盈利丰，续降至55增加止盈频次提升总收益
- name: max_holding_days
  ...
  reason: time_stop胜率68%均盈1006，60日让趋势发展，暂维持
- name: trail_stop_pct
  default: 0.1
  range:
  - 0.05
  ...
  reason: v10 trail放宽致少数大亏，收紧至0.10及早锁利，降低单次亏损
- name: partial_profit_pct
  ...
  reason: 续降止盈门槛至0.08，激发更多盈利减仓，overbought_reduce胜率高贡献盈利
- name: atr_stop_multiplier
  ...
  reason: v10波动止损触发5万次均亏，提高至4.5减少噪音止损，让趋势发展
- name: fixed_stop_loss_pct
  ...
  reason: v8总亏损更小启示紧止损；收紧至0.10控制单笔风险，可能减少总亏损
...
- name: vol_breakout_threshold
  ...
  reason: v8阈值约2.3时breakout质量高，回调至2.3均衡信号数量与质量
...
- name: rsi_entry_high
  ...
  reason: 提高至70扩大入场范围，配合rsi_entry_low=55，捕捉温和追高机会
