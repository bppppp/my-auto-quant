...
- name: partial_profit_pct
  ...
  reason: v6 0.12致overbought均收仅4867,v4 0.15达5895,提至0.13渐进提升单笔质量
...
- name: atr_stop_multiplier
  ...
  reason: v6 2.0致vol_stop 26242次噪音(胜率12.6%),恢复v5的2.5过滤
- name: trail_stop_pct
  default: 0.12
  range:
  - 0.05
  ...
  reason: v6 0.13仅触发1065次(v5为3515),利润未充分跑出,回退0.12
- name: vol_breakout_threshold
  ...
  reason: 入场触发=0参数未生效,1.0为A股合理值,保持
...
- name: target_holdings
  ...
  reason: 与max_single=0.1匹配,8只×10%=80%资金利用率合理,保持
- name: rsi_overbought
  default: 74
  range:
  - 65
  ...
  reason: v4 75时overbought均收5895最佳,v6 73仅4867,提至74渐进优化
- name: fixed_stop_loss_pct
  ...
  reason: v5 0.13大亏-4331,v6 0.12为-4037,0.12在深度/频次间平衡,保持
- name: add_position_weight_threshold
  ...
  reason: 入场触发=0未生效,0.3已很低,保持待入场逻辑修复
- name: max_turnover_per_rebalance
  ...
  reason: 组合层参数,与盈亏比核心问题无关,5份报告稳定,保持
- name: rsi_entry_low
  default: 30
  range:
  - 15
...
- name: max_holding_days
  ...
  reason: v6 30天time_stop 86.9%胜率+1443均收良好,5份报告稳定,保持
...
- name: max_single_weight
  ...
  reason: 与target_holdings=8匹配,集中度非年化低主因,保持
