...
- name: partial_profit_pct
  ...
  reason: v9-v13 overbought_reduce均100%胜率+5800,稳定,保持0.15
- name: rebalance_freq_days
  ...
  reason: 组合层参数,5份报告无频率问题,5日与波段匹配,保持
- name: rsi_entry_high
  default: 80
  range:
  - 50
...
- name: atr_stop_multiplier
  ...
  reason: v13 3.0触发8101次胜率3.93%噪音大,适度放宽至3.3过滤近端波动
- name: trail_stop_pct
  default: 0.11
  range:
  - 0.05
  ...
  reason: v13 0.10触发9041次(v11 1474的6倍)方差主导,适度放宽至0.11降噪
...
- name: rsi_overbought
  ...
  reason: v9-v13 overbought_reduce均100%胜率+5800,稳定,保持75
- name: fixed_stop_loss_pct
  ...
  reason: v13触发1660次胜率0%与trail联调观察,方差不主导时再调,保持0.12
...
- name: max_holding_days
  ...
  reason: v9-v13 time_stop胜率72-82%均正+1100,30日贴合波段,保持
