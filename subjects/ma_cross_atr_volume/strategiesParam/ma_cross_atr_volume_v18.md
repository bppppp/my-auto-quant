...
- name: add_position_weight_threshold
  ...
  reason: 加仓逻辑v17仍未触发,持仓无加仓记录,维持0.05
- name: volume_breakout_ratio
  ...
  reason: 量能1.15在p75=1.19附近,过滤稳定,v17维持
- name: max_holding_days
  ...
  reason: time_stop均利v13→v17递增61551→68507且100%胜率,延120捕捉更多盈利
...
- name: fixed_stop_pct
  ...
  reason: v17触发92次0%胜率兜底,0.13仍合理,维持
- name: bear_drawdown_threshold
  ...
  reason: v17回撤-14.51%稳定在-15%内,熊市阈值-0.08合理,维持
- name: trailing_stop_pct
  ...
  reason: v17的0.15较v16胜率61.96→64.71%/均利20092→23513均升,验证维持
