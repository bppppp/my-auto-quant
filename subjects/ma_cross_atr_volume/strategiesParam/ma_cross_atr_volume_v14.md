...
- name: volume_breakout_ratio
  ...
  reason: 量能过滤有效,盈亏比2.51达标,维持1.15
- name: max_holding_days
  ...
  reason: v13→80天均利61551,v14延展至85天继续捕获最强出场信号
...
- name: fixed_stop_pct
  ...
  reason: 0.14灾损保护层,v13触发39次0%胜率,维持
- name: bear_drawdown_threshold
  ...
  reason: 回撤-14.48%在-15%目标内,熊市防御有效,维持
- name: trailing_stop_pct
  ...
  reason: 0.15→0.14微紧,胜率35.6%偏低,稍紧止损提升胜率
