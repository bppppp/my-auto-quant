...
- name: add_position_weight_threshold
  ...
  reason: v6胜率36.97%与v5持平,加仓灵敏性合理,维持0.05
- name: volume_breakout_ratio
  ...
  reason: p75=1.19原1.2过严,降至1.1放开入场,提升年化
- name: max_holding_days
  ...
  reason: time_stop胜率99.63%均利33075,延至60d捕更多趋势利润
...
- name: bear_drawdown_threshold
  ...
  reason: v6回撤-14.60%近-15%目标,熊市防御必要,维持-0.08
- name: trailing_stop_pct
  ...
  reason: v4该值trailing胜率51%>v6的50%,收紧0.08锁利
