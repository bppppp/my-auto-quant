...
- name: add_position_weight_threshold
  ...
  reason: 加仓逻辑仍未触发,v16持仓无加仓记录,维持0.05
- name: volume_breakout_ratio
  ...
  reason: 量能阈值1.15在p75=1.19附近,过滤稳定,v16维持
- name: max_holding_days
  ...
  reason: time_stop均利67856最高且100%胜率,但已到上限90,维持
...
- name: fixed_stop_pct
  ...
  reason: v16触发51次0%胜率兜底,0.13仍合理,维持
- name: bear_drawdown_threshold
  ...
  reason: v16回撤-14.50%稳定在-15%内,熊市阈值-0.08合理,维持
- name: trailing_stop_pct
  ...
  reason: v16的0.14触发降至1028、胜率61.96%、均利20092均最优,微宽至0.15继续验证
