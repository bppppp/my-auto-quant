...
- name: volume_breakout_ratio
  ...
  reason: 1.3在p75(1.19)上偏严,触发<25%,降至1.2放宽入场
- name: max_holding_days
  ...
  reason: v2(45天)time_stop贡献31.7M>v4(60天)27.9M,降至50平衡
...
- name: bear_drawdown_threshold
  ...
  reason: 回撤-14.5%接近-15%目标,收紧至-0.08加强防御
- name: trailing_stop_pct
  ...
  reason: 0.09处合理区间(v4:51%胜+6794均),维持不变
