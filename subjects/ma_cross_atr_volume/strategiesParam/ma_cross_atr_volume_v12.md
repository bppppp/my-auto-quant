...
- name: add_position_weight_threshold
  ...
  reason: 加仓逻辑未被出场信号触及,v11分散度合理,维持0.05
- name: volume_breakout_ratio
  ...
  reason: 1.15过滤弱量能有效,盈亏比2.45达标,维持
- name: max_holding_days
  ...
  reason: time_stop胜率99.83%均利49212最强,70→75延长赢家持仓
...
- name: fixed_stop_pct
  ...
  reason: v11仅触发1次已失效,微放宽至0.14进一步减少灾损
- name: bear_drawdown_threshold
  ...
  reason: 回撤-14.65%在-15%目标内,熊市防御有效,维持-0.07
- name: trailing_stop_pct
  ...
  reason: v11触发1421次57%胜率,继续放宽至0.14让趋势延展
...
- name: max_single_weight
  ...
  reason: 0.14集中度合理,回撤-14.65%可控,维持
