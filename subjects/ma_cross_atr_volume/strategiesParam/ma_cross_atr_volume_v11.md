...
- name: add_position_weight_threshold
  ...
  reason: v10 0.05加仓阈值合理,无出场信号触及,维持
- name: volume_breakout_ratio
  ...
  reason: 1.15过滤弱量能有效,v10盈亏比2.37达标,维持
- name: max_holding_days
  ...
  reason: time_stop胜率99.73%均利42599,65→70让赢家多跑5日
- name: rebalance_freq_days
  ...
  reason: 5日与波段持仓匹配,swallowed低位,维持
- name: fixed_stop_pct
  default: 0.13
  range:
  - 0.05
  ...
  reason: v10触发301次0胜均亏15069,放宽至0.13减少灾损
- name: bear_drawdown_threshold
  ...
  reason: 回撤-14.75%在-15%目标内,熊市防御有效,维持-0.07
- name: trailing_stop_pct
  ...
  reason: v10胜率59%均利12762,继续放宽至0.13让趋势延展
...
- name: atr_min_threshold
  ...
  reason: atr/close均值3.76%已远超0.02,过滤已生效,维持
