...
- name: add_position_weight_threshold
  ...
  reason: 加仓逻辑未被出场信号触及,v12分散度合理,维持0.05
- name: volume_breakout_ratio
  ...
  reason: 量能过滤有效,v12盈亏比2.47达标,维持1.15
- name: max_holding_days
  ...
  reason: time_stop胜率100%均利55213,75→80延展最强出场信号
...
- name: bear_drawdown_threshold
  ...
  reason: 回撤-14.51%在-15%目标内,熊市防御有效,维持
- name: trailing_stop_pct
  ...
  reason: v12触发1032次胜率60%均利16348,继续放宽至0.15
...
- name: max_single_weight
  ...
  reason: 0.14集中度合理,回撤-14.51%可控,维持
