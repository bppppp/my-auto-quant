...
- name: volume_breakout_ratio
  ...
  reason: v8入场1.1偏松(对应p60-65),微紧至1.15过滤弱量能假突破
- name: max_holding_days
  ...
  reason: v8 time_stop胜率99.88%均利35312,60d是甜区,维持
...
- name: bear_drawdown_threshold
  ...
  reason: v8回撤-14.80%逼近-15%目标,维持-0.07防御
- name: trailing_stop_pct
  ...
  reason: v8 trailing胜率51%偏低,放宽至0.10让更多持仓延展到time_stop
