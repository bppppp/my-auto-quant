...
- name: rsi_overbought
  ...
  reason: 提升至84，减少过早止盈，v19超买胜率97.7%可延长持有
- name: trailing_stop_pct
  ...
  reason: 维持15%保护利润，v19移动止损胜率41%均利570效果良好
- name: reduce_position_risk_threshold
  ...
  reason: 提高至9%，放宽波动容忍减少减仓，v19回撤仅4.8%风险可控
...
- name: max_industry_concentration
  ...
  reason: 提高至50%，回撤远低于目标，适度集中持仓提升收益
- name: atr_min
  default: 0.015
  range:
  - 0.01
  ...
  reason: 降低至0.015，扩大选股范围，v19入场次数17036可再提升
...
- name: rsi_high
  ...
  reason: 提升至80，释放更多强势股入场信号，年化收益偏低需扩大机会
- name: fixed_stop_pct
  default: 0.13
  range:
  - 0.05
  ...
  reason: 微放宽至13%，减少趋势初期震出，v19止损触发均亏3836可改善
- name: rsi_low
  default: 30
  range:
  - 30
  ...
  reason: 降至30，放宽入场信号，回撤空间充足可承受更多交易
- name: max_holding_days
  ...
  reason: 延长至75天，v19时间止盈胜率100%均利7455，可捕获更长趋势
- name: add_position_profit_threshold
  ...
  reason: v19回撤仅4.8%，可提前加仓；降低至6%以放大趋势盈利
- name: target_holdings
  ...
  reason: 减少至7只，集中持股提高单票贡献，回撤承受力强
- name: vol_min
  default: 1.0
  range:
  - 1.0
